...
require_once THEME_API . '/v1/endpoints/class.Rest.Invite.Controller.php';
...
require_once THEME_API.'/v1/endpoints/class.Rest.Service.Thread.Controller.php';
}
require_once THEME_API.'/v1/endpoints/class.Rest.Service.Common.Controller.php';