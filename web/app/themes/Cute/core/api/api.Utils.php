...
function tt_add_rest_index_link($response) {
    $response->add_link( 'theme', 'https://bbcatga.herokuapp.com' );
    return $response;
}
...
//    }
    ...
    // Invite
    $invite_controller = new WP_REST_Invite_Controller();
    $invite_controller->register_routes();
    ...
    // Card
    $card_controller = new WP_REST_Card_Controller();
    $card_controller->register_routes();
  
    // Thread
    if (TT_PRO && tt_get_option('tt_enable_k_thread', false)) {
    $thread_service_controller = new WP_REST_Thread_Controller();
    $thread_service_controller->register_routes();
    }

    // Common Service
    $common_service_controller = new WP_REST_Common_Service_Controller();
    $common_service_controller->register_routes();
