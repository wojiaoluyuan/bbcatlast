...
class WP_REST_Comment_Controller extends WP_REST_Controller
{
    ...
    public function get_items( $request ) {
        ...
        return tt_api_success($comment_list . '<div class="load-more-comment"></div>', array('count' => $count, 'nextPage' => $comment_page + 1));
    }
...
//        }
        ...
        $comment_html = wp_list_comments(array(
            'type'=>'all',
            'callback'=>$post_type=='product' && $product_rating ? 'tt_shop_comment' : 'tt_comment',
            'end-callback'=>'tt_end_comment',
            'max_depth'=>3,
            'reverse_top_level'=>0,
            'style'=>'div',
