...
class WP_REST_Message_Controller extends WP_REST_Controller
{
    ...
    public function create_item($request)
    {
        ...
        tt_mark_all_message_read($receiver_id);
    ...
    public function delete_item( $request ) {
        ...
        if(!$result) {
            return new WP_Error( 'rest_cannot_delete', __( 'The message cannot be deleted.', 'tt' ), array('status' => tt_rest_authorization_required_code()) );
        }
