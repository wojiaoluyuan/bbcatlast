...
<?php
/**
 * Class WP_REST_Thread_Controller.
 */
class WP_REST_Thread_Controller extends WP_REST_Controller
{
    public function __construct()
    {
        $this->namespace = 'v1';
        $this->rest_base = 'threadservice';
    }
    ...
    public function exec_service_permissions_check($request)
    {
        ...
        $allow_services_kv = (array) json_decode(ALLOWED_THREAD_SERVICES);
    ...
    {
        return tt_exec_thread_api_services($request['service'], $request->get_params());
    }
}
