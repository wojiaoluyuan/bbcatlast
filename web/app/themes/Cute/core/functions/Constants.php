...
/* Tint Site Url */
defined('TT_SITE') || define('TT_SITE', 'https://bbcatga.herokuapp.com');
...
$site_allow_utils = json_encode(array(
    ...
    'payinvite' => 'PayInvite',
    'paydonate' => 'PayDonate',
    'weibo_image_check' => 'Weibo_Image_Check',
    'weibo_image_rest' => 'Weibo_Image_Rest'
));
...
$site_endpoints = json_encode(array(
    ...
    'aliqrpay'                  =>  'site/aliqrpay',
    'kpay'                      =>  'site/kpay',
    'kpaynotify'                =>  'site/kpaynotify',
    'apsvnotify'                =>  'site/apsvnotify',
    'youzannotify'              =>  'site/youzannotify',
    'upload'                    =>  'site/upload',
	'custom_css'				=>	'site/css',
    'payinvite'				    =>	'site/payinvite',
    'paydonate'				    =>	'site/paydonate',
    'api_root'                  =>  'api',
    'signin'                    =>  'm/signin',
    'signup'                    =>  'm/signup',
    'activate'                  =>  'm/activate',
    ...
    'cash_notify'               =>  'me/notifications/cash',
...
/* 通用API服务列表 */
$common_api_services = json_encode(array(
    'common.widget.credit.data' => 1, // 1代表必须鉴权，0则不需要
    'common.widget.credit.sign' => 1
    // TODO: Add more
));
defined('ALLOWED_COMMON_SERVICES') || define('ALLOWED_COMMON_SERVICES', $common_api_services);
