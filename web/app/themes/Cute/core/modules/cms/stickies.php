                ...
                <?php foreach ($stickies as $sticky) { ?>
                    ...
                    <article id="<?php echo 'post-' . $sticky['ID']; ?>" class="post type-post sticky-post status-publish <?php echo 'format-' . $sticky['format']; ?>">
                        <div class="entry-thumb hover-scale">
                            <a href="<?php echo $sticky['permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><img src="<?php echo LAZY_PENDING_IMAGE; ?>" data-original="<?php echo $sticky['thumb']; ?>" class="thumb-medium wp-post-image lazy" alt="<?php echo $sticky['title']; ?>"></a>
                        </div>
                        <div class="entry-detail">
                            <h3 class="entry-title">
                                <a href="<?php echo $sticky['permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $sticky['title']; ?></a>
                            </h3>
