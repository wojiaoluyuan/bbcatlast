                        ...
                        <table class="table table-striped table-framed table-centered">
                            ...
                            <?php foreach ($orders as $order){ ?>
                                <tr id="oid-<?php echo $order->order_id; ?>">
                                    ...
                                    <td><a <?php if($order->user_id > 0){echo 'href="'.tt_url_for('manage_user', $order->user_id).'"';}; ?> target="_blank"><?php if($order->user_id > 0){echo get_user_meta($order->user_id, 'nickname', true);}else{echo 'System';}; ?></a></td>
