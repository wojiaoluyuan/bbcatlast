...
<div class="col col-right credits">
    ...
    <div class="me-tab-box credits-tab">
        <div class="tab-content me-credits">
            ...
            <section class="credits-info clearfix">
                ...
                <div class="info-group clearfix">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9"><p><?php echo tt_get_referral_link($tt_user_id); ?></p></div>
                    </div>
                </div>
            </section>
            <!-- 积分充值 -->
            <section class="credits-charge clearfix" id="chargeCredits">
                <header><h2><?php _e('Credits Charge', 'tt'); ?></h2></header>
                <div class="info-group clearfix">
                    <div class="form-group charge-credits-form">
                        <?php $min_credit_price = tt_get_option('tt_hundred_min_credit_price',5); $credit_price = tt_get_option('tt_hundred_credit_price', 1); ?>
                        <label><?php printf(__('当前积分兑换比率为：100 积分 = %d 元', 'tt'), $credit_price); ?></label>
                        <label><?php printf(__('，最低充值 %d 元', 'tt'), $min_credit_price); ?></label>
                        <div class="form-inline">
                            <div class="form-group">
                                <div class="input-group active">
                                    <div class="input-group-addon"><?php _e('Credits*100', 'tt'); ?></div>
                                    <input class="form-control" type="number" min="1" name="credits-charge-num" value="<?php echo $min_credit_price / $credit_price; ?>" aria-required="true" required="">
                                </div>
                            </div>
            ...
            <!-- 积分获取方式 -->
            <section class="credits-approach clearfix" id="creditsApproach">
                ...
                <div class="info-group clearfix">
                    <table class="table table-centered table-framed table-striped credit-table">
                        ...
                        <tr>
                            <td><?php _e('文章资源售出', 'tt'); ?></td>
                            <td><?php printf(__('%s 积分', 'tt'), tt_get_option('tt_bought_resource_rewards_ratio', 100) . '%'); ?></td>
                            <td><?php printf(__('%s次数', 'tt'), '不限'); ?></td>
                        </tr>
                        <tr>
