                ...
                <div class="info-group clearfix">
                    ...
                    <div class="col-md-6 notifications-filter">
                        ...
                        <select class="form-control select select-primary" data-toggle="select" onchange="document.location.href=this.options[this.selectedIndex].value;">
                            ...
                            <option value="<?php echo tt_url_for('cash_notify'); ?>" <?php if(strtolower($tt_filter_type) == 'cash') echo 'selected'; ?>><?php _e('余额通知', 'tt'); ?></option>
                    ...
                    <div class="info-group clearfix">
                        <ul class="notifications-list">
                            <?php foreach ($notifications as $notification) { ?>
                                <li id="notification-<?php echo $notification->msg_id; ?>">
                                <?php _e('Send Time: ', 'tt'); ?><span><?php echo $notification->msg_date; ?></span>
                                <?php _e('Sender: ', 'tt'); ?><span>
                                ...
                                <span class="record-text"><?php echo $notification->msg_title; ?></span>
