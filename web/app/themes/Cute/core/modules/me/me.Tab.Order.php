    ...
    <div class="me-tab-box order-tab">
        <div class="tab-content me-order">
            ...
            <section class="pay-content clearfix">
                ...
                <div class="info-group clearfix">
                    <?php $order_id_arr = explode('_',$order->order_id); ?>
                    <?php if (strpos($order->order_id, '_') !== false && $order_id_arr[1] != '0') { ?>
                    <p><?php echo sprintf(__('请至<a href="%1$s" target="_blank">下载页</a>查看', 'tt'), tt_url_for('download', $order->product_id)); ?></p>
                    <?php } elseif($order_id_arr[1] == '0') { ?>
                    <p><?php echo sprintf(__('请至<a href="%1$s" target="_blank">文章页</a>查看', 'tt'), get_permalink($order->product_id)); ?></p>
                    <?php } else { ?>
                    <?php if($is_combined) { ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9">
                            <div class="form-control-static">
                                ...
                                <p>下载地址: <a href="<?php echo $download['link']; ?> " target="_blank"><?php echo $download['link']; ?></a></p>
