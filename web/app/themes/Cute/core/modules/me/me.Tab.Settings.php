    ...
    <div class="me-tab-box setting-tab">
        <div class="tab-content me-settings">
            ...
            <section class="info-basis clearfix">
                ...
                <div class="form-group info-group clearfix">
                    <label class="col-md-2 control-label"><?php _e('Personal Cover', 'tt'); ?></label>
                    <div class="col-md-10">
                        <div class="user-cover"><img src="<?php echo $info->cover; ?>" /><label class="changeimgicon cover-upload cover-picker img-picker" title="<?php _e('Change Cover', 'tt'); ?>"></label>
                        </div>
                    </div>
                </div>
                <div class="form-group info-group clearfix">
