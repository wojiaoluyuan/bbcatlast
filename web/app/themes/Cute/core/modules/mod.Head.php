...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo THEME_CDN_ASSET.'/vender/js/html5shiv/3.7.3/html5shiv.min.js'; ?>"></script>
    <script src="<?php echo THEME_CDN_ASSET.'/vender/js/respond/1.4.2/respond.min.js'; ?>"></script>
    <![endif]-->
    <!--[if lte IE 7]>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="<?php echo THEME_CDN_ASSET.'/css/'.CSS_BASE; ?>" />
    ...
    <!-- 作者小工具扩展及其他工具标题动画效果 -->
    <link rel="stylesheet" type="text/css" href="<?php echo THEME_CDN_ASSET.'/css/custom.css'; ?>"  />
    <?php } ?>
    <script><?php echo 'var VUETT='.VUETT; ?></script>
    <script src="<?php echo THEME_CDN_ASSET.'/vue/vue.runtime.min.js'; ?>"></script>
    <!-- 页头自定义代码 -->
    <?php if(tt_get_option('tt_head_code')) { echo tt_get_option('tt_head_code'); } ?>
    <?php wp_head(); ?>
    <script type="text/javascript" src="<?php echo THEME_CDN_ASSET.'/js/emoji.list.js'; ?>"></script>
    <script type="text/javascript" src="<?php echo THEME_CDN_ASSET.'/js/jquery.emoji.min.js'; ?>"></script>
