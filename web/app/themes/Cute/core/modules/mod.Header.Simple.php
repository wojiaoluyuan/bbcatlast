...
<head>
    ...
    <?php wp_head(); ?>
    <script type="text/javascript" src="<?php echo THEME_ASSET.'/js/emoji.list.js'; ?>"></script>
    <script type="text/javascript" src="<?php echo THEME_ASSET.'/js/jquery.emoji.min.js'; ?>"></script>
</head>