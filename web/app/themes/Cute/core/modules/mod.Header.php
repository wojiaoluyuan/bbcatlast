...
<?php } ?>
    ...
    <div class="qr-wrap"> <div class="qrcode col-md-6 col-sm-6 col-xs-12"><div class="wx-qr"><img src="<?php echo $wechat_pay; ?>" title="扫一扫二维码打赏我"></div></div>
    <div class="qrcode col-md-6 col-sm-6 col-xs-12">
    <div class="ali-qr">
    <img src="<?php echo $ali_pay; ?>" title="扫一扫二维码打赏我"></div></div></div></div>
    <!-- 打赏浮窗注释结束 -->
    <?php } ?>
    <?php } ?>
    <header class="header">
        ...
        <div class="header__inner">
          <div class="container header__content">
            ...
            <a class="header__logo" href="<?php echo home_url(); ?>">
              <img src="<?php echo tt_get_option('tt_logo'); ?>" alt="<?php echo get_bloginfo('name'); ?>" class="dark">
              <img src="<?php echo tt_get_option('tt_logo_light'); ?>" alt="<?php echo get_bloginfo('name'); ?>" class="light"></a>
            <!-- Top Menu -->
...
<?php if(is_single() && in_array(get_post_type(), array('post', 'product', 'page'))) { ?>
<!-- 顶部公告 -->
