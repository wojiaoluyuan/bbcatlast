                ...
                <div class="<?php echo $card_col_mod_num;?>">
                    ...
                    <article id="<?php echo 'post-' . $latest_post['ID']; ?>" class="post type-post status-publish wow bounceInUp">
                        <div class="entry-thumb hover-scale">
                            <a href="<?php echo $latest_post['permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>>
                                ...
                                <?php if($latest_post['price_text'] == '免费资源'){ ?>
                                     <span class="post-free"><i class="fa fa-ticket"></i> <?php echo $latest_post['price_text']; ?></span>
                                      <?php }elseif(!empty($latest_post['price_text'])){ ?>
                                      <span class="post-price"><i class="fa fa-ticket"></i> <?php echo $latest_post['price_text']; ?></span>
                               <?php } ?>
                          </a>
