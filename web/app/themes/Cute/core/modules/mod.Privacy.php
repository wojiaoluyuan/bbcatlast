...
<h2>引言</h2>
<p>您使用或继续使用我们(<a href="<?php echo $blogurl; ?>" title="<?php echo $blogname; ?>" data-toggle="tooltip" target="_blank"><?php echo $blogname; ?></a>)的服务，即意味着同意我们按照本《隐私政策和版权声明》(以下简称声明)收集、使用、储存和分享您的相关信息。</p>
<p>如对本《声明》或相关事宜有任何问题，请通过<?php echo $admin_email; ?>与我们联系。</p>
