...
<aside class="product-info__section product-info__section--author">
    <a href="<?php echo $productdata->author_url; ?>"><img src="<?php echo $productdata->author_thumb; ?>" width="80" height="80" alt="themestall" class="avatar wp-user-avatar"></a><strong><?php echo $productdata->author; ?></strong>
</aside>
