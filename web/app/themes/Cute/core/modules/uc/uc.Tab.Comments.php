                    ...
                    <?php foreach ($uc_comments as $uc_comment) { ?>
                        <div id="<?php echo 'comment-' . $uc_comment['comment_ID']; ?>" class="<?php echo $uc_comment['class']; ?>">
                            <div class="comment-title" title="<?php echo $uc_comment['comment_date_diff']; ?>">
                                <span class="comment-author"><img class="avatar lazy" src="<?php echo LAZY_PENDING_AVATAR; ?>" data-original="<?php echo $uc_comment['author_avatar']; ?>"><?php echo $uc_comment['comment_datetime']; ?></span><?php _e('REVIEW', 'tt'); ?><a href="<?php echo $uc_comment['post_permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $uc_comment['post_title']; ?></a>
                            </div>
