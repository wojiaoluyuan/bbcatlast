                        ...
                        <div class="box-inner transition">
                            ...
                            <?php if ($follower['ID'] != $logged_user_id) { ?>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo $follower['home']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php _e('View Homepage', 'tt'); ?></a></li>
                                    <li><a href="<?php echo $follower['posts_url']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php _e('His Posts', 'tt'); ?></a></li>
                                    <li><a href="<?php echo $follower['comments_url']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php _e('His Comments', 'tt'); ?></a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="<?php echo $follower['following_url']; ?>"><?php _e('Check Activities', 'tt'); ?></a></li>
                                </ul>
                            <?php } ?>
                            </div>
                        </div>
