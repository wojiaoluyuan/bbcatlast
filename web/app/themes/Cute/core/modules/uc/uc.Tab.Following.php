                                ...
                                <div class="user-interact">
                                    <?php if ($following['ID'] != $logged_user_id) { ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo $following['home']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php _e('View Homepage', 'tt'); ?></a></li>
                                            <li><a href="<?php echo $following['posts_url']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php _e('His Posts', 'tt'); ?></a></li>
                                            <li><a href="<?php echo $following['comments_url']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php _e('His Comments', 'tt'); ?></a></li>
