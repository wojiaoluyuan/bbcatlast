                    ...
                    <?php foreach ($uc_star_posts as $uc_star_post) { ?>
                        <article id="<?php echo 'post-' . $uc_star_post['ID']; ?>" class="post type-post status-publish <?php echo 'format-' . $uc_star_post['format']; ?>">
                            <div class="entry-thumb hover-scale">
                                <a href="<?php echo $uc_star_post['permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><img width="250" height="170" src="<?php echo LAZY_PENDING_IMAGE; ?>" data-original="<?php echo $uc_star_post['thumb']; ?>" class="thumb-medium wp-post-image lazy" alt="<?php echo $uc_star_post['title']; ?>"></a>
                                <?php echo $uc_star_post['category']; ?>
                            </div>
                            <div class="entry-detail">
                                <header class="entry-header">
                                    <h2 class="entry-title"><a href="<?php echo $uc_star_post['permalink']; ?>" rel="bookmark"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $uc_star_post['title']; ?></a></h2>
                                    <div class="entry-meta entry-meta-1">
                                        <span class="author vcard"><a class="url" href="<?php echo $uc_star_post['author_url']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $uc_star_post['author']; ?></a></span>
                                        ...
                                        <span class="comments-link text-muted"><i class="tico tico-comments-o"></i><a href="<?php echo $uc_star_post['permalink'] . '#respond'; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $uc_star_post['comment_count']; ?></a></span>
