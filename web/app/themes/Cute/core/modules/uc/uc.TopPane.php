...
<section class="billboard author-header mb20" style="background-image: url(<?php echo tt_get_user_cover($tt_author_vars['tt_author_id']); ?>)">
    <div class="container text-center">
        ...
        <h2><?php echo tt_get_privacy_mail($tt_author_vars['tt_author']->display_name); ?><?php if(get_current_user_id() == $tt_author_vars['tt_author_id']){ ?><a class="edit-profile" href="<?php echo tt_url_for('my_settings'); ?>"><i class="tico tico-pencil2"></i></a><?php } ?></h2><!-- TODO vip gender icon -->
