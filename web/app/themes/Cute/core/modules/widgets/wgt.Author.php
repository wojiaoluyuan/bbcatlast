...
class AuthorWidget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="widget-content">
            <a class="author-card_bg" href="<?php echo $data->homepage; ?>" style="background-image: url(<?php echo $data->cover; ?>)" tabindex="-1"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>></a>
            <div class="author-card_content">
                <a class="author_avatar-link" href="<?php echo $data->homepage; ?>" title="<?php echo $data->display_name; ?>" tabindex="-1"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><img class="avatar" src="<?php echo $data->avatar; ?>" alt=""></a>
