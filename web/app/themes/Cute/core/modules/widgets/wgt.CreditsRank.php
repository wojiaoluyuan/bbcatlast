                    ...
                    <li>
                        <span class="index">
                            <?php if ($rank_item->index == 1) { ?>
                                <img src="<?php echo THEME_CDN_ASSET.'/img/rank/Rank-1.png'; ?>">
                             <?php } else if ($rank_item->index == 2) { ?>
                                <img src="<?php echo THEME_CDN_ASSET.'/img/rank/Rank-2.png'; ?>">
                             <?php } else if ($rank_item->index == 3) { ?>
                                <img src="<?php echo THEME_CDN_ASSET.'/img/rank/Rank-3.png'; ?>">
                             <?php } else { 
