        ...
        <?php foreach ($hothit_posts as $hothit_post) { ?>
            <article id="<?php echo 'post-' . $hothit_post['ID']; ?>" class="post type-post status-publish hothit-post">
                <div class="entry-thumb hover-scale">
                    <a href="<?php echo $hothit_post['permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><img width="200" height="136" src="<?php echo LAZY_PENDING_IMAGE; ?>" data-original="<?php echo $hothit_post['thumb']; ?>" class="thumb-small wp-post-image lazy" alt="<?php echo $hothit_post['title']; ?>"></a>
                </div>
                <div class="entry-detail">
                    <h2 class="entry-title"><a href="<?php echo $hothit_post['permalink']; ?>" rel="bookmark"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $hothit_post['title']; ?></a></h2>
                    <div class="entry-meta entry-meta-1">
                        <span class="view-count text-muted"><i class="tico tico-eye"></i><?php echo $hothit_post['views']; ?></span>
