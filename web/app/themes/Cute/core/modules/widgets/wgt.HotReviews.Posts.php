...
class HotReviewPosts extends WP_Widget {
    function __construct() {
        parent::__construct(false, __('TT-Hot Reviewed Posts', 'tt'), array( 'description' => __('TT-Show several most reviewed posts', 'tt') ,'classname' => 'widget_hot-posts widget_hotreviewed-posts wow bounceInRight'));
    }
            ...
            <?php foreach ($hotreviewed_posts as $hotreviewed_post) { ?>
                <article id="<?php echo 'post-' . $hotreviewed_post['ID']; ?>" class="post type-post status-publish hotreview-post">
                    <div class="entry-thumb hover-scale">
                        <a href="<?php echo $hotreviewed_post['permalink']; ?>"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><img width="200" height="136" src="<?php echo LAZY_PENDING_IMAGE; ?>" data-original="<?php echo $hotreviewed_post['thumb']; ?>" class="thumb-small wp-post-image lazy" alt="<?php echo $hotreviewed_post['title']; ?>"></a>
                    </div>
                    <div class="entry-detail">
                        <h2 class="entry-title"><a href="<?php echo $hotreviewed_post['permalink']; ?>" rel="bookmark"<?php echo tt_get_option('tt_enable_k_blank', false) ?  ' target="_blank"' : ''; ?>><?php echo $hotreviewed_post['title']; ?></a></h2>
