...
<!--                        <input autocomplete="off" name="password" type="text" class="input password-input" id="password-input" title="Password" required="required" onclick="this.type='password'" placeholder="--><?php //_e('Password', 'tt'); ?><!--">-->
                    ...
                    <span>
                        <a href="<?php echo home_url(); ?>" class="btn btn-lg btn-primary btn-block" style="width: auto;background: 0 0;border: 1px solid #fff;margin-bottom: 10px;">返回首页</a>
                        <button class="btn btn-lg btn-primary btn-block" id="signin-btn" type="submit" style="margin-left: 65px;width:auto;">立刻登录</button>
                    </span>
                </div>
				<!-- Open Login -->
                <?php
