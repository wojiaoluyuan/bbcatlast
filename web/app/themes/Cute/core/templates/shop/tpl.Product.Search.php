    ...
    <div class="hero hero--animate" style="height: 450px"> 
        ...
        <div class="hero__inner"> 
            <div class="hero__content"> 
                <h1><i class="tico tico-search"></i> <?php printf(__('关键词: %s'), $search); ?></h1>
            </div>
        </div>
    </div> 
</section>
                ...
                <?php foreach ($products as $key=>$product) { ?>
                    <li class="col product" id="<?php echo 'product-' . $product['ID']; ?>">
                        ...
                        <small class="wcvendors_sold_by_in_loop"> 
                            <span class="wcvendors-profile-image" style="background-image: url('<?php echo $product['author_thumb']; ?>');"></span><?php echo $product['author']; ?></small>
                    </li>
                <?php } ?>
            </ul>
        </div> 
