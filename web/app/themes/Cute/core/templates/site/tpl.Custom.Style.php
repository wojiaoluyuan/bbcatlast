...
#main .article-footer>.post-copyright {background: rgba(252, 248, 227, <?php echo $main_transparent; ?>)!important;}
...
header.white {background: rgba(255, 255, 255, <?php if($main_transparent < 1){echo 0.8;}else{echo 1;}; ?>);}
#topBulletins {background: rgba(23, 168, 227, <?php if($main_transparent < 1){echo 0.8;}else{echo 1;}; ?>);}
.callout-danger, .callout-error {background-color: rgba(255, 238, 230, <?php if($main_transparent < 1){echo $main_transparent - 0.2;}else{echo 1;}; ?>);}
.callout-info,.bg-info,.bg-lightbulb{background-color: rgba(235, 245, 255, <?php if($main_transparent < 1){echo $main_transparent - 0.2;}else{echo 1;}; ?>);}
.callout-warning,.bg-warning {background-color: rgba(255, 245, 230, <?php if($main_transparent < 1){echo $main_transparent - 0.2;}else{echo 1;}; ?>);}
.callout-success, .bg-success{background-color: rgba(230, 250, 240, <?php if($main_transparent < 1){echo $main_transparent - 0.2;}else{echo 1;}; ?>);}
.bg-error{background-color: rgba(255, 238, 230, <?php if($main_transparent < 1){echo $main_transparent - 0.2;}else{echo 1;}; ?>);}
#latest-posts .block5-widget .widget-title {background: rgba(255, 255, 255, <?php echo $main_transparent; ?>) !important;}
#cms-cats .cat-col .cat-container .cms-cat-s7 .col-md-4 article{background: rgba(255, 255, 255, <?php echo $main_transparent; ?>)!important;}
...
.nt-slider {height:<?php echo tt_get_option('tt_k_custom_slider_height', '500'); ?>px}
