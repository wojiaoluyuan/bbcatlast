                            ...
                            <article id="<?php echo 'post-' . $tag_post['ID']; ?>" class="post type-post status-publish wow bounceInUp">
                                <div class="entry-thumb hover-scale">
                                    <a href="<?php echo $tag_post['permalink']; ?>">
                                      ...
                                      <?php if($tag_post['price_text'] == '免费资源'){ ?>
                                     <span class="post-free"><i class="fa fa-ticket"></i> <?php echo $tag_post['price_text']; ?></span>
                                      <?php }elseif(!empty($tag_post['price_text'])){ ?>
                                      <span class="post-price"><i class="fa fa-ticket"></i> <?php echo $tag_post['price_text']; ?></span>
                                      <?php } ?>
                                    </a>
