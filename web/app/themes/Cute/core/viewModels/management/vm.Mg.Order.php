...
class MgOrderVM extends BaseVM {
    ...
    protected function getRealData() {
        $order = tt_get_order_by_sequence($this->_orderSeq) ? tt_get_order_by_sequence($this->_orderSeq) : tt_get_order($this->_orderSeq);
...
//        }
        ...
        return (object)array(
            ...
            'pay_price' => $order->order_total_price,
            'pay_currency' => $order->order_currency,
