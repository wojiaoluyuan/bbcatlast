 ...
 * Class ShopSearchVM
 */
class ShopSearchVM extends BaseVM {
    ...
    public static function getInstance($page = 1, $search = '') {
        $instance = new static();
        $instance->_cacheKey = 'tt_cache_' . $instance->_cacheUpdateFrequency . '_vm_' . __CLASS__ . '_page' . $page . '_search' . $search . '_user' . get_current_user_id();
...
//        }
        ...
        while ($query->have_posts()) : $query->the_post();
            ...
            $product['author_thumb'] = tt_get_avatar($post->post_author, 'small');
