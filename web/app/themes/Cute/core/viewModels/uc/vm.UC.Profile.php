...
class UCProfileVM extends BaseVM {
    ...
    protected function getRealData() {
        ...
        $author_info['latest_login'] = mysql2date('Y/m/d H:i:s', $data->tt_latest_login);
        $author_info['latest_login_before'] = mysql2date('Y/m/d H:i:s', $data->tt_latest_login_before);
