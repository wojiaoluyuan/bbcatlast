...
function left_admin_footer_text($text) {
    $text = '<span>感谢使用 <a href="https://bbcatga.herokuapp.com">BBCat</a> 主题定义您的网站样式，最新更新内容请查看 <a href="https://bbcatga.herokuapp.com/bbcatga-update-list" style="color: deeppink;">主题更新列表</a>.</span>';
   return $text;
}
