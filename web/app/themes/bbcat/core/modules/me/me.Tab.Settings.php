    ...
    <div class="me-tab-box setting-tab">
        <div class="tab-content me-settings">
            ...
            <section class="info-basis clearfix">
                ...
                <label class="col-md-2 control-label" style="line-height: normal;">帐号ID</label> 
                <p class="col-md-10"><?php echo $tt_user_id; ?></p></div>
				<div class="form-group info-group clearfix">
                <label class="col-md-2 control-label" style="line-height: normal;">用户组</label> 
                <p class="col-md-10"><?php echo tt_get_user_cap_string($tt_user_id); ?></p></div>
                <div class="form-group info-group clearfix">
            ...
            <section class="info-extends clearfix">
                ...
                <div class="form-group info-group clearfix">
                    ...
                    <p class="col-md-10">
                        ...
                        <span class="help-block"><?php _e('微博用户名, 如weibo.com/rogenart中的rogenart', 'tt'); ?></span>
                    </p>
                </div>
                <div class="form-group info-group clearfix">
                ...
                <div class="form-group info-group clearfix">
                    ...
                    <p class="col-md-10">
                        ...
                        <span class="help-block"><?php _e('Twitter用户名, 如twitter.com/wojiaoluyuan中的wojiaoluyuan', 'tt'); ?></span>
                    </p>
                </div>
                <div class="form-group info-group clearfix">
                    ...
                    <p class="col-md-10">
                        ...
                        <span class="help-block"><?php _e('Facebook用户名, 如www.facebook.com/RogenRu中的RogenRu', 'tt'); ?></span>
                    </p>
                </div>
                <div class="form-group info-group clearfix">
                    ...
                    <p class="col-md-10">
                        ...
                        <span class="help-block"><?php _e('Google+用户ID, 如plus.google.com/u/0/?中的?', 'tt'); ?></span>
                    </p>
                </div>
                <div class="form-group info-group clearfix">
