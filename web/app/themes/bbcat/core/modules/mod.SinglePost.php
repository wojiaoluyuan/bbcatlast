    ...
    <div class="post">
      ...
      <div class="single-body wow bounceInUp">
            <aside class="share-bar">
                <a class="share-btn share-weibo" href="<?php echo 'https://service.weibo.com/share/share.php?url=' . $postdata->permalink . '&count=1&title=' . $postdata->title . ' - ' . get_bloginfo('name') . '&pic=' . urlencode($postdata->thumb) . '&appkey=' . tt_get_option('tt_weibo_openkey'); ?>" title="<?php _e('Share to Weibo', 'tt'); ?>" target="_blank"></a>
                <a class="share-btn share-qzone" href="<?php echo 'https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=' . $postdata->permalink . '&summary=' . $postdata->excerpt . '&title=' . $postdata->title . ' - ' . get_bloginfo('name') . '&site=' . get_bloginfo('name') . '&pics=' . urlencode($postdata->thumb); ?>" title="<?php _e('Share to QZone', 'tt'); ?>" target="_blank"></a>
                <a class="share-btn share-qq" href="<?php echo 'https://connect.qq.com/widget/shareqq/index.html?url=' . $postdata->permalink . '&title=' . $postdata->title . ' - ' . get_bloginfo('name') . '&summary=' . $postdata->excerpt . '&pics=' . urlencode($postdata->thumb) . '&flash=&site=' . get_bloginfo('name') . '&desc='; ?>" title="<?php _e('Share to QQ', 'tt'); ?>" target="_blank"></a>
