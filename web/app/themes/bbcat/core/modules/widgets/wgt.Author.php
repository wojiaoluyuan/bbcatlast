  ...
  <ul class="items clearfix">
   <?php if($qq = get_the_author_meta( 'tt_qq',  $author_id)) { ?>
    <span class="social-widget-link social-link-qq">
      ...
      <a href="<?php echo 'https://wpa.qq.com/msgrd?v=3&uin=' . $qq . '&site=qq&menu=yes'; ?>" target="_blank" rel="nofollow"></a>
    </span>
    <?php } ?>
    ...
    <span class="social-widget-link social-link-weibo">
      ...
      <a href="<?php echo 'https://www.weibo.com/' . $weibo; ?>" target="_blank" rel="nofollow"></a>
    </span>
    <?php } ?>
    ...
    <span class="social-widget-link social-link-email">
      ...
      <a href="<?php echo 'https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&amp;email=' . $email; ?>" target="_blank" rel="nofollow"></a>
    </span>
    <?php } ?>
  </ul>
</div>
