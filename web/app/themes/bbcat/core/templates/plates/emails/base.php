                ...
                <table width="750" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td width="100%" style="border-radius:4px;background:#ffffff;" bgcolor="#ffffff" align="center">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                <tr>
                                    <td width="50%" align="left"><div style="width:150px;height:60px;padding: 15px 0 0 20px;"><img src="<?=$this->e($logo)?>"  title="<?=$this->e($blogName)?>" style="display:inline;margin:0;max-height:50px;width: auto;" border="0"></div></td>
                                    <td width="50%" align="right"><div style="width:250px;height:60px;line-height:60px;padding-right:20px;">
                                            ...
                                            <?php if(defined('TT_PRO') && TT_PRO) { ?>
                                            <a href="<?=$this->e($shopHome)?>" title="" style="font-size:12px;line-height:60px;color:#222222;text-decoration:none;border:none;padding:0 6px;">商店</a>
                                            <?php } ?>
                                            <a href="<?=$this->e($home)?>/me" title="" style="font-size:12px;line-height:60px;color:#222222;text-decoration:none;border:none;padding:0 6px;">个人中心</a>
                                        </div></td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        ...
                        <td width="100%" align="center" style="font-size:10px;line-height: 1.5;color: #999999;padding: 5px 0;text-align:center;">
                            ...
                            <p style="margin:10px 0 0;">版权所有 © <?php echo tt_copyright_year(); ?> <?=$this->e($blogName)?></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
