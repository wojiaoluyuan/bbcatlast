        ...
        <div class="row">
            ...
            <div class="content-area col-sm-12 col-md-7 col-md-push-2 col-lg-7 col-lg-push-2 boundary-column" id="primary">
                <main id="main-content" role="main">
                    ...
                    <!-- Message box here -->
                    <!-- Product -->
                    <div itemscope itemtype="https://schema.org/Product" id="product-<?php echo $productdata->ID; ?>" class="product type-product">
                            ...
                            <div class="view-share">
                                <div class="share">
                                    <div class="share-bar">
                                        ...
                                        <a class="share-btn share-weibo" href="<?php echo 'https://service.weibo.com/share/share.php?url=' . $productdata->permalink . '&count=1&title=' . $productdata->title . ' - ' . get_bloginfo('name') . '&pic=' . urlencode($productdata->thumb) . '&appkey=' . tt_get_option('tt_weibo_openkey'); ?>" title="<?php _e('Share to Weibo', 'tt'); ?>" target="_blank"></a>
                                        <a class="share-btn share-qzone" href="<?php echo 'https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=' . $productdata->permalink . '&summary=' . $productdata->excerpt . '&title=' . $productdata->title . ' - ' . get_bloginfo('name') . '&site=' . get_bloginfo('name') . '&pics=' . urlencode($productdata->thumb); ?>" title="<?php _e('Share to QZone', 'tt'); ?>" target="_blank"></a>
                                        <a class="share-btn share-qq" href="<?php echo 'https://connect.qq.com/widget/shareqq/index.html?url=' . $productdata->permalink . '&title=' . $productdata->title . ' - ' . get_bloginfo('name') . '&summary=' . $productdata->excerpt . '&pics=' . urlencode($productdata->thumb) . '&flash=&site=' . get_bloginfo('name') . '&desc='; ?>" title="<?php _e('Share to QQ', 'tt'); ?>" target="_blank"></a>
                        ...
                        <section class="summary entry-summary">
                            ...
                            <div class="commerce-product-rating" itemprop="aggregateRating" itemscope="" itemtype="https://schema.org/AggregateRating">
                            ...
                            <!-- Price -->
                            <div class="commerce-product-price" itemprop="offers" itemscope="" itemtype="https://schema.org/Offer">
                                <p class="price">
                                    <!-- TODO VIP Price -->
                                    ...
                                    <?php }else{ ?>
                                        <del><?php echo $productdata->price_icon; ?><span class="price original-price"><?php echo $productdata->price; ?></span></del>
                                        <?php echo $productdata->price_icon; ?>
                                        <ins><span class="price discount-price"><?php echo $productdata->min_price; ?></span></ins>
                                    <?php } ?>
                                </p>
                            ...
                            <div class="product_meta">
                                <div class="sku_wrapper"><?php _e('SKU: ', 'tt'); ?><span class="sku" itemprop="sku"><?php echo $productdata->ID; ?></span></div>
                                <div>
                                    <span class="sales_wrapper" style="margin-right: 10px;"><?php _e('Sales: ', 'tt'); ?><span class="sales" itemprop="sales"><?php if($productdata->sales > 0) : echo $productdata->sales; else : echo '0'; endif; ?></span></span>
                                ...
                                <div class="posted_in"><?php _e('Categories: ', 'tt'); ?><?php echo implode(', ', $cat_breads); ?></div>
                            </div>
                        </section>
                        <!-- Tabs -->
