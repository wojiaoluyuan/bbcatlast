...
//        $user_info['this_login_ip'] = $data->tt_latest_login_ip;
        ...
        $user_info['qq'] = $data->tt_qq; //$data->tt_qq ? 'https://wpa.qq.com/msgrd?v=3&uin=' . $data->tt_qq . '&site=qq&menu=yes' : '';
        $user_info['weibo'] = $data->tt_weibo; //$data->tt_weibo ? 'https://weibo.com/' . $data->tt_weibo : '';
