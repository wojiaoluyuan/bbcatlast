...
class UCProfileVM extends BaseVM {
    ...
    protected function getRealData() {
        ...
        $author_info['qq'] = $data->tt_qq ? 'https://wpa.qq.com/msgrd?v=3&uin=' . $data->tt_qq . '&site=qq&menu=yes' : ''; //get_user_meta($author->ID, 'tt_qq', true);
        $author_info['weibo'] = $data->tt_weibo ? 'https://weibo.com/' . $data->tt_weibo : ''; //get_user_meta($author->ID, 'tt_weibo', true);
