...
function optionsframework_option_name() {
	...
	return 'options-framework-theme-bbcat';
}
...
function optionsframework_options() {
   ...
   // 用户QQ群
    $options[] = array(
        'name' => __( '用户QQ群', 'tt' ),
        'desc' => sprintf(__( '<br><h2><a href="%s" target="_blank">BBcat主题用户/WordPress交流群：721910579</a></h2>', 'tt'), 'https://jq.qq.com/?_wv=1027&k=5n6NV2Z'),
        'type' => 'info'
    );
...
//    );
  ...
  // - 网站背景颜色
    ...
    $options[] = array(
        'name' => __( '启用旧版首页', 'tt' ),
        'desc' => __( '启用旧版Tinection主题首页CMS模板', 'tt' ),
        'id' => 'tt_enable_tinection_home',
        'std' => false,
        'type' => 'checkbox'
    );
    ...
    $options[] = array(
        'name' => __('分类页面其他模板', 'tt'),
        'desc' => __('分类页面默认使用文章列表+边栏双栏布局，若要使用块状布局，请在此勾选对应分类', 'tt'),
...
//    );
    ...
    $options[] = array(
        ...
        'desc' => __('主题程序的JS/CSS/IMG的CDN存放路径URL, css/js/img文件夹位于该路径下, 默认为本站BBcat主题assets文件夹的路径, 更改为CDN的assets路径将从CDN加速主题的JS/CSS/IMG文件', 'tt'),
        'id' => 'tt_bbcat_static_cdn_path',
        'std' => THEME_ASSET,
        'type' => 'text'
    );
  ...
  //    $options[] = array(
   ...
   //   $options[] = array(
   //       'name' => __( '交流论坛', 'tt' ),
   //       'desc' => sprintf(__( '<br><h2><a href="%s" target="_blank">BBcat主题/WordPress交流论坛</a></h2>', 'tt'), 'https://elune.me'),
   //       'type' => 'info'
   //   );
  ...
  //        'name' => __( 'Contact Author', 'tt' ),
    //      'desc' => sprintf(__( '<br><h2>Email: lu321yuan@163.com</h2><br><h2>Wechat & Alipay & QQ(below)</h2><br><img src="%s"><img src="%s"><img src="%s"> ', 'tt' ), THEME_ASSET . '/img/qr/weixin.png', THEME_ASSET . '/img/qr/alipay.png', THEME_ASSET . '/img/qr/qq.png'),
   //       'type' => 'info'
  //    );
...
$options[] = array(
        'name' => __( 'K版个性化CSS', 'tt' ),
        'desc' => __( '启用K版扩展相关CSS(启用下列功能必须开启CSS，否则页面错乱，此功能包含了所有额外功能CSS，包括七彩标签，导航栏定位，footer的样式等，必须开启)', 'tt' ),
        'id' => 'tt_enable_k_css',
        'std' => true,
        'type' => 'checkbox'
    );
  // 版块漂浮动画/打字特效/点击特效
   $options[] = array(
        'name' => __( '版块漂浮动画/打字特效/点击特效', 'tt' ),
        'desc' => __( '启用版块漂浮动画/打字特效/点击特效（wordpress默认小工具需要手动添加动画的class，具体方法到交流群询问管理员）', 'tt' ),
...
$options[] = array(
  ...
  $options[] = array(
        ...
        'type' => 'checkbox'
         ...
         // 右侧返回顶部浮动工具栏额外按钮
  $options[] = array(
        'name' => __( '右侧返回顶部浮动工具栏额外按钮', 'tt' ),
        'desc' => __( '启用右侧返回顶部浮动工具栏额外按钮（可在BBcat/core/modules/mod.FixedControls.php中添加更多功能）', 'tt' ),
        'id' => 'tt_enable_k_fdgj',
        'std' => true,
        'type' => 'checkbox'
    );
  ...
  $options[] = array(
        ...
        'type' => 'checkbox'
              ...
              //开启文章列表新样式
  $options[] = array(
        'name' => __( '开启文章列表新样式', 'tt' ),
        'desc' => __( '启用文章列表新样式（包括最新文章列表，分类文章列表以及搜索文章列表的新样式）', 'tt' ),
        'id' => 'tt_enable_k_postlistnews',
        'std' => true,
        'type' => 'checkbox'
    );
        //开启文章页新样式
  ...
  $options[] = array(
        ...
        'type' => 'checkbox'
          ...
          //开启免登录下载免费附件
  $options[] = array(
        'name' => __( '开启免登录下载免费附件', 'tt' ),
        'desc' => __( '启用免登录下载免费附件', 'tt' ),
